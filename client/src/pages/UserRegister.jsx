            ...
            {step === 1 && (
              <div>
                ...
                <div className="space-y-4">
                  ...
                  {/* Specific Options Dropdown (shown when a discussion matter is selected) */}
                  {/* {showSpecificOptions && (
                    <select
                      name="onboarding.technologies[0].item"
                      value={formData.onboarding.technologies[0].item}
                  ...
                  {/* Design Improvement */}
                  <textarea
                    name="onboarding.details.designImprovement"
                    placeholder="Design Improvement"
                    value={formData.onboarding.details.designImprovement}
                    onChange={handleChange}
                    rows={3}
                    className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 mt-4"
                  />
